# The following module has been modified by Andre Roberge from a
# Python Cookbook recipe with the following statement:
...
# The modification include the removal of time limits and allowing
# try/except/finally.
...
class TestSafeEval(unittest.TestCase):
    ...
    #    # provide an imported module via import
    #    self.value = 0
    #    env = {'value': self.value}
    #    exec "import random" in env
    #    safe_eval("value = random.randint(0,3)", env)
    #    self.assertEqual(0<self.value< 4, True)
