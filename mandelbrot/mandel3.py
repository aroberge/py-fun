...
class Viewer(object):
    def __init__(self, parent, width=500, height=500):
        ...
        self.shift_x = 0.5*self.screen_width
        self.shift_y = 0.5*self.screen_height
        self.scale = 0.01
    ...
    def complex_plane_to_screen(self, coordinate, shift):
        '''converts complex plane coordinate into coordinate on the screen.'''
        return (coordinate/self.scale) + shift
